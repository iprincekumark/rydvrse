...
export function EmptyStateArtwork({ variant = "booking", width = 140, height = 96 }: EmptyStateArtworkProps) {
  return (
    <Svg width={width} height={height} viewBox="0 0 140 96" fill="none">
      <Rect x="10" y="18" width="120" height="64" rx="16" fill="#FFFFFF" stroke="rgba(229,231,235,0.6)" />
      <Rect x="26" y="32" width="88" height="8" rx="4" fill="#F3F4F6" />
      <Rect x="26" y="48" width="64" height="8" rx="4" fill="#F3F4F6" />
      {variant === "booking" ? (
        <>
          <Path d="M34 68C48 58 65 56 104 62" stroke="#1B6EF3" strokeWidth="3.2" strokeLinecap="round" />
          <Circle cx="34" cy="68" r="4.5" fill="#1B6EF3" />
          <Circle cx="104" cy="62" r="4.5" fill="#1B6EF3" />
        </>
      ) : null}
      {variant === "jobs" ? (
        <>
          <Rect x="48" y="58" width="44" height="16" rx="8" fill="#1B6EF3" />
          <Path d="M58 66H82" stroke="#FFFFFF" strokeWidth="2.4" strokeLinecap="round" />
        </>
      ) : null}
      {variant === "support" ? (
        <>
          <Circle cx="72" cy="66" r="12" fill="#1B6EF3" />
